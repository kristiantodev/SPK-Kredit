...
<head>
    ...
    <title>SPK Pemberian Kredit Pensiun</title>
<link href='<?php echo base_url() ?>assets/image/nasari.png' rel='shotcut icon'>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h3 text-gray-900 mb-4">Login<br>Sistem Penunjang Keputusan</h1>
                                        <img src="<?php echo base_url() ?>assets/image/nasari.png" alt="" height="135"><br>
                                    </div>
                            ...
                            <?php endif; ?>  
                                    ...
                                    <form action="<?php base_url('login') ?>" method="post" enctype="multipart/form-data" class="user">
                                        ...
                                        <select class="form-control" name='level' required style="width: 100%;" >
                                         ...
                                         <option value="bagiankredit">Bagian Kredit</option>
                                         <option value="pimpinan">Pimpinan</option>
                                         </select>
                                         </div>

                                        <button type="submit" class="btn btn-warning btn-user btn-block"><b><i class="fas fa-sign-in-alt "></i>&nbsp; MASUK</b></button>
